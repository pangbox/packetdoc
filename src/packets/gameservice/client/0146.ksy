...
doc: |
  ...
  The response is [Gameservice Server 0x0216 User Status Update](/packets/gameservice/server/0216.ksy) (for the items),
  and [Gameservice Server 0x0214 Mail Take Attachments Response](/packets/gameservice/server/0214.ksy) (for acknowledgement?).
